...
(function(){
  ...
  .sb-mono{width:38px;height:38px;border-radius:50%;flex:none;overflow:hidden;background:radial-gradient(circle,#fff,#EFE7CC);border:2px solid #C9A24B;display:flex;align-items:center;justify-content:center;cursor:pointer}
  ...
  .sb-ava{width:26px;height:26px;border-radius:50%;object-fit:cover;border:1.5px solid #C9A24B;display:block;background:#fff}
  ...
  sb.className='tbmsb';
  sb.innerHTML=
    '<div class="sb-top"><span class="sb-mono" id="sbMono"><img src="/logo.png?v=2" alt="" id="sbMonoImg"></span><span class="sb-name">Charleston</span><button class="sb-toggle" id="sbToggle" title="Collapse">&#171;</button></div>'+
    '<nav class="sb-nav">'+
  ...
  function showPaywall(){
    ...
    ov.innerHTML='<div class="pwc"><img src="/logo.png?v=2" width="78" height="78" alt="" style="display:block;margin:0 auto">'
